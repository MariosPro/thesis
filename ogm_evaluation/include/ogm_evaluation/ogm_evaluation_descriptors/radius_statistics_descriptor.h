...
#ifndef RADIUS_STATISTICS_DESCRIPTOR_H
#define RADIUS_STATISTICS_DESCRIPTOR_H
...
namespace ogm_evaluation
{
  ...
  class RadiusStatisticsDescriptor : public DescriptorExtractor
  {
    public:
      ...
      **/
      ...
      @return void
      **/ 
      RadiusStatisticsDescriptor(void);
 
      /**
      @brief Default destructor
      @return void
      **/ 
      virtual ~RadiusStatisticsDescriptor(void)
      {
      };
  };
}
