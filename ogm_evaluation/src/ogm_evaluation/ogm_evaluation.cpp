...
/*      cv::threshold(_groundTruthMap, _groundTruthMap, 0, 255, cv::THRESH_BINARY);*/
  ...
  /*  cv::erode(_groundTruthMap, _groundTruthMap, cv::Mat(), cv::Point(-1, -1), 2, 1, 1);*/
    ...
    _metric =  _metric_factory.createMetricInstance(req.method, _groundTruthMap, _slamMap, _transform, req.detector, req.descriptor, req.matcher, req.closestPointMethod, req.distNorm, req.matchingRatio, req.ransacReprjError);
