/******************************************************************************
   ...
   Copyright (C) 2015 OGM Simulator
...
{
  ogm_gui::COgmApplication app(argc, argv);
  app.setAttribute(Qt::AA_DontShowIconsInMenus, false);
  ros::init(argc, argv, "ogm_gui_node", ros::init_options::NoSigintHandler);
  ogm_gui::CGuiController con(argc, argv);
